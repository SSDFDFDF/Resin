...
const EXACT_ZH_TO_EN: Record<string, string> = {
  ...
  "订阅源过滤": "Subscription Filter",
  "按订阅源隔离当前平台可用节点": "Isolate routable nodes for this platform by subscription source",
  "排除选中订阅": "Exclude selected subscriptions",
  "仅包含选中订阅": "Include selected subscriptions only",
  "订阅源过滤列表": "Subscription filter list",
  "暂无订阅源": "No subscriptions yet",
  "未知订阅": "Unknown subscription",
  "搜索订阅源": "Search subscriptions",
