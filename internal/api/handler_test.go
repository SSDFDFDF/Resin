...
func TestSystemEnvConfig_OK(t *testing.T) {
	...
	if body["default_platform_regex_filter_invert"] != true {
		t.Errorf("default_platform_regex_filter_invert: got %v, want true", body["default_platform_regex_filter_invert"])
	}
